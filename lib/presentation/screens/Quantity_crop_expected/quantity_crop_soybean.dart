...
class SoyBeanQuantity extends StatefulWidget {
  const SoyBeanQuantity({super.key});

  @override
  State<SoyBeanQuantity> createState() => _SoyBeanQuantityState();
}

class _SoyBeanQuantityState extends State<SoyBeanQuantity> {
              ...
              child: Padding(
                ...
                child: MaterialButton(
                  onPressed: () {
                    setState(() {
                      if (measure == "Acre") {
                        result = (area * 625/288).toDouble() ;
                      } else if (measure == "Carat") {
                        result = (area * 625/12).toDouble() ;
                      } else {
