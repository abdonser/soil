...
class MaizeQuantity extends StatefulWidget {
  const MaizeQuantity({super.key});

  @override
  State<MaizeQuantity> createState() => _MaizeQuantityState();
}

class _MaizeQuantityState extends State<MaizeQuantity> {
              ...
              child: Padding(
                ...
                child: MaterialButton(
                  onPressed: () {
                    setState(() {
                      if (measure == "Acre") {
                        result = (area * 25/4).toDouble() ;
                      } else if (measure == "Carat") {
                        result = (area * 150).toDouble() ;
                      } else {
