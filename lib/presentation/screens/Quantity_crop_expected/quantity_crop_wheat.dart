...
class WheateQuantity extends StatefulWidget {
  const WheateQuantity({super.key});

  @override
  State<WheateQuantity> createState() => _WheateQuantityState();
}

class _WheateQuantityState extends State<WheateQuantity>{
