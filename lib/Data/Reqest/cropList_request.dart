...
import '../../domain/model/cropListModel.dart';

class CropListRequest {
  static getCropList(
      {required Function(List<CropList>) onSuccess,
    ...
    await http
        .get(Uri.parse("http://10.0.2.2:8000/api/croplist"), headers: headers)
        .then((response) {
      if (response.statusCode == 200) {
        ...
        CropListModel cropListModel = CropListModel.fromJson(decoded);
        onSuccess(cropListModel.cropList);
